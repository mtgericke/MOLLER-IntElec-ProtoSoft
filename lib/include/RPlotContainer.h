...
private:
  ...
  PlotContainerOptions         *dPlotOptions;
...
public:
  ...
  Int_t                GetPlotCount();
  PlotContainerOptions         *GetPlotOptions(){return dPlotOptions;};
  ...
  void                 SetPlotOptions(PlotContainerOptions *options);

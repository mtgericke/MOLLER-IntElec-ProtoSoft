...
//Version 000
//
//RDataWindow header file, declaring basic methods to display data in a window.
...
#ifndef RDATAWINDOW_H
#define RDATAWINDOW_H
...
class RDataWindow : public TGTransientFrame {
...
/*   char                 dSelectedRootFileObj[NAME_STR_MAX]; */
  ...
  TRootEmbeddedCanvas *fPlotCanvas;
  TGWindow            *fMrec;
  TLegend             *fLegend;
  TObject             *fCurrPlot;
 ...
 protected:
  ...
  TRootEmbeddedCanvas *GetPlotCanvas() {return fPlotCanvas;};
 ...
 public:
  ...
  RDataWindow(const TGWindow *p, const TGWindow *main,
